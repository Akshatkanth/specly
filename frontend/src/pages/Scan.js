...
const Scan = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black px-4 pt-24 relative">
      <div className="w-full max-w-3xl flex flex-col items-center justify-center">
        ...
        {result && (
          <div className="mt-6 w-full bg-white rounded-xl shadow-lg p-6 space-y-4">
